...
This project is indexed by GitNexus as **dextree** (1416 symbols, 2281 relationships, 57 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
