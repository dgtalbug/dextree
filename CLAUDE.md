...
This project is indexed by GitNexus as **dextree** (1052 symbols, 1781 relationships, 76 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
