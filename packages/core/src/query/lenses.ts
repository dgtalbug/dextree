 ...
 * `importance`, and `fanIn` — keeping the input type narrow lets tests
 * construct lightweight fixtures.
 */
...
/**
 * Substring that MUST appear in the disabled-stub tooltip. Tests assert on
 * the substring, not the full sentence, so copy tweaks remain green.
 */
export const STUB_TOOLTIP_REQUIRED_SUBSTRING = "slice 026" as const;
