// AUTO-GENERATED from tree-sitter-elixir/queries/tags.scm — do not edit by hand.
// Regenerate: pnpm --filter @dextree/core gen:tags
import type { LanguageProvider, ProviderConfig } from "../types.js";

const TAGS = String.raw`; Definitions
...
export const TREE_SITTER_ELIXIR_PROVIDERS: readonly LanguageProvider[] = [
  { language: "elixir", tagsQuery: TAGS, config: CONFIG },
];
